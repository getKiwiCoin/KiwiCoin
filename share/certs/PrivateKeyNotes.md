...
unlocked to sign the Kiwicoin-Qt.app bundle.
...
allowing somebody to distribute a Kiwicoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the kiwicoin-qt.exe file inside the installer had not been tampered with.

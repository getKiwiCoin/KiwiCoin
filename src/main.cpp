...
uint256 hashGenesisBlock("0x0000011378138640e92b0a4c8fcde3c3e8bfed8fa95d010058a3f58d1807e4ba");
...
static const int nHardForkOne = 20;
...
const string strMessageMagic = "Kiwicoin Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uRPD
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 345000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 200000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3600; // Kiwicoin: 1 Hour
static const int64 nTargetSpacing = 60; // Kiwicoin: 60 Seconds
...
{
        static const int64 BlocksTargetSpacing = 60; // Kiwicoin: 1 Minute
        static const unsigned int TimeDaySeconds = 3600; // Kiwicoin: 1 Hour
...
void ThreadScriptCheck() {
    RenameThread("Kiwicoin-scriptch");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000011378138640e92b0a4c8fcde3c3e8bfed8fa95d010058a3f58d1807e4ba");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        const char* pszTimestamp = "KiwiCoin 07/Jun/2014 KiwiCoin Relaunched";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 0xa61f46e1 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        block.nVersion = 1;
        block.nTime    = 1402102581;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084897192;
        ...
        assert(block.hashMerkleRoot == uint256("0x129e0708b1ab2be7f00b7ccbac48c3efe0338b3d6a405854aa8a1d8c0c347f9a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa6, 0x1f, 0x46, 0xe1 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KiwicoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KiwicoinMiner : ProcessBlock, block not accepted");
    }
